...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-r from-blue-50 to-pink-500 text-white">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-pink-500 to-blue-50 text-white">
